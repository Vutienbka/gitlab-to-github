...
Rails.application.config.assets.precompile += %w[color.css users/*.sass users/*.scss]
Rails.application.config.assets.precompile += %w[users/sample_input.scss users/batch_items_selector.scss]
